 ...
 * </p>
 * <ul>
 *   <li>{@link net.sf.orcc.cal.cal.Generator#getVariable <em>Variable</em>}</li>
 *   <li>{@link net.sf.orcc.cal.cal.Generator#getLower <em>Lower</em>}</li>
 *   <li>{@link net.sf.orcc.cal.cal.Generator#getHigher <em>Higher</em>}</li>
 * </ul>
 *
 * @see net.sf.orcc.cal.cal.CalPackage#getGenerator()
 * @model
 * @generated
 */
public interface Generator extends EObject
{
   ...
   * @see net.sf.orcc.cal.cal.CalPackage#getGenerator_Variable()
  ...
  /**
   * Sets the value of the '{@link net.sf.orcc.cal.cal.Generator#getVariable <em>Variable</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see net.sf.orcc.cal.cal.CalPackage#getGenerator_Lower()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.sf.orcc.cal.cal.Generator#getLower <em>Lower</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see net.sf.orcc.cal.cal.CalPackage#getGenerator_Higher()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.sf.orcc.cal.cal.Generator#getHigher <em>Higher</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->

 ...
 * </p>
 * <ul>
 *   <li>{@link net.sf.orcc.cal.cal.impl.GuardImpl#getExpressions <em>Expressions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GuardImpl extends MinimalEObjectImpl.Container implements Guard
{
  ...
  {
    return CalPackage.Literals.GUARD;
  }
  ...
  public EList<AstExpression> getExpressions()
  {
    if (expressions == null)
    {
      expressions = new EObjectContainmentEList<AstExpression>(AstExpression.class, this, CalPackage.GUARD__EXPRESSIONS);
    }
    return expressions;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CalPackage.GUARD__EXPRESSIONS:
